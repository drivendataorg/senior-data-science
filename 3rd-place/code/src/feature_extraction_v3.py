...
def entropy(arr): #TODO: check again
    """
...
def extract_accel(accel):
    if(accel.shape[0]<4): #insufficient
...
for train_test in ('train', 'test',):
    ...
    for fi, file_id in enumerate(os.listdir('../input/public_data/{}/'.format(train_test))):
        ...
        df.to_csv('../input/public_data/{}/{}/columns_v3.csv'.format(train_test, stub_name),
