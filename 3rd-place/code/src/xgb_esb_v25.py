...
def load_sequences(file_ids):
    ...
    file_list = ["xgb_v5.val.txt", 
                 ...
                 "xgb_v14.val.txt",
                 "xgb_v15.val.txt",
                 "0.177727_xgb_v16.val.txt",
                 "0.172985_xgb_v18.val.txt",
                 "0.171675_xgb_v19.val.txt",
                 "0.169296_xgb_v21.val.txt",
                 "0.171486_xgb_v20.val.txt",
                 "0.168089_xgb_v22.val.txt",
                 "0.194267_nn_v20.val.txt",
                 "0.172592_xgb_v24.val.txt",
                 "0.178048_xgb_v25.val.txt",
                 ]
    for f in file_list:
...
def predict(model, test_x, filename, isXgb=False):
    ...
    df = pd.read_csv("../sub/0.181267_xgb_v5.tst.csv")
...
def xgb_model(train_x, train_y):
    ...
    np.savetxt("../models/xgb_esb_v25.val.txt", val_preds)
...
def main():
    ...
    predict(clf, test_x, "../sub/xgb_esb_v25.tst.csv", True)
