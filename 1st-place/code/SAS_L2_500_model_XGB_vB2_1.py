...
def predict_model(train_x, train_y, test_x, test_y=None, class_weights=None, random_state=0):
    ...
    param = {'n_estimators':600, 'seed':1, 'missing':np.nan, 'nthread':-1,
             'max_depth':4, 'learning_rate':0.01, 'colsample_bytree':0.05, 'subsample':0.9}
