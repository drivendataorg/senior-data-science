...
data_source =['ds_video_sta_M10_v1B_s2', 'ds_rssi_M00_v1A_s2', 'ds_accel_M01_v2A', 'ds_video_fig_M03_v1A_s1',
              'ds_video_mov_M10_v1A_s2', 'ds_video_sta_M06_v1A_s1', 'ds_rssi_M16_v1A_s2', 'ds_accel_M00_v1A_s1'
             ] + ['ds_video_sta_M03_v1B_s1', 'ds_accel_M00_v1A_s2', 'ds_rssi_M32_v1A_s2', 'ds_video_mov_M03_v1B_s2', 
               'ds_video_fig_M06_v1A_s2', 'ds_rssi_M00_v1A_s1', 'ds_pir_M1s_v1', 'ds_video_mov_M10_v1A_s2'
               ] + ['ds_video_sta_M03_v1B_s1', 'ds_accel_M00_v1A_s2', 'ds_rssi_M32_v1A_s1', 'ds_accel_M01_v1B_s1', 
               'ds_pir_M2s_v1', 'ds_accel_M10_v2C', 'ds_video_mov_M10_v1A_s2', 'ds_video_sta_M10_v1A_s1'
               ] + ['ds_video_sta_M06_v1B_s2', 'ds_rssi_M32_v1A_s2', 'ds_accel_M03_v2B', 'ds_pir_M2s_v1', 
                'ds_rssi_M04_v1C_s2', 'ds_video_mov_M01_v1B_s1', 'ds_video_mov_M10_v1A_s1', 'ds_rssi_M00_v1A_s2'
                ] + ['ds_video_sta_M06_v1B_s2', 'ds_accel_M00_v2B', 'ds_rssi_M32_v1C_s2', 'ds_video_fig_M01_v1B_s2', 'ds_accel_M10_v2D', 
                'ds_rssi_M00_v1A_s2', 'ds_video_mov_M10_v1B_s1', 'ds_pir_M2s_v1']
data_source =np.unique(data_source)
...
def predict_model(train_x, train_y, test_x, test_y=None, class_weights=None, random_state=0):
    ...
    param = {'n_estimators':200, 'seed':1, 'missing':np.nan, 'nthread':12,
